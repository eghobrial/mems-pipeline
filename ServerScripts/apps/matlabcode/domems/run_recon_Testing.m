function run_recon_Testing ()
% Usage: run_recon_Testing()
% Function configure parameters (with fewer reps and no parallel processing toolbox for testing) before calling spiralfmap2 based on the
...
% addpath('/apps/matlabcode/spiralfmap2-wFastOption/irt/utilities', '-begin');
% addpath('/apps/matlabcode/spiralfmap2-wFastOption', '-begin');
% addpath('/apps/afni_matlab/afni_matlab/matlab', '-begin');
% % 
addpath('/apps/matlabcode/spiralfmap2-wFasterOption/irt/utilities', '-begin');
addpath('/apps/matlabcode/spiralfmap2-wFasterOption', '-begin');
addpath('/apps/afni_matlab/afni_matlab/matlab', '-begin');
...
recon(2,:) = {{'slgrappa', 1,{sprintf('%s/%s', ddir, pfname{1})}, {} , 'reps', 1:100}};
%recon(2,:) = {{'slgrappa', 1, {sprintf('%s/%s', ddir, pfname{1})},{}, 'slices', 1, 'reps', 1:10}};
